...
class NotificationController extends Controller
{
    ...
    public function destroy(Notification $notification)
    {
        ...
        return redirect()->route(module_release_2_meta('kebab').'.user.notifications.index')->with('success', 'Notification deleted successfully.');
    }
    ...
    public function markAsRead(Notification $notification)
    {
        ...
        return redirect()->route(module_release_2_meta('kebab').'.user.notifications.index')->with('success', 'Notification marked as read successfully.');
    }
    ...
    public function markAllAsRead()
    {
        ...
        return redirect()->route(module_release_2_meta('kebab').'.user.notifications.index')->with('success', 'All notifications marked as read successfully.');
    }
    ...
    public function clearAll()
    {
        ...
        return redirect()->route(module_release_2_meta('kebab').'.user.notifications.index')->with('success', 'All notifications deleted successfully.');
    }
}
