...
>
    ...
    <div class="text-sm p-4 bg-gray-100 rounded-lg text-gray-600 dark:text-gray-400 mb-6">
        Roles define user access across the entire system. 
        Changing roles and permissions is a <span class="font-bold">highly sensitive action</span> 
        that may affect security and data accessibility. 
        Please make sure you fully understand the consequences before making any changes. 
        <span>
                    ...
                    <td>
                        <div class="flex flex-wrap gap-1">
                            @foreach ($role->permissions as $permission)
                                <x-badge text="{{ $permission->name }}" size="sm" color="secondary-light" />
                            @endforeach
                        </div>
                    </td>
                        ...
                        >
                            <div class="p-2">
                                ...
                                <div class="border-t border-gray-200 dark:border-gray-700 pt-1 mt-1">
                                    <a 
                                        @click="$dispatch('open-modal', { name: 'modal-delete', selectedId: '{{ $role->id }}', selectedName: '{{ ucfirst($role->name) }}' })"
                                        href="#"
        ...
        >
            ...
            <div class="flex flex-col items-center text-center px-6 pb-6">
                ...
                <p class="text-gray-700 text-sm leading-relaxed max-w-md">
                    Roles are critical data. Deleting a role may affect other related records in the system.
                </p>
